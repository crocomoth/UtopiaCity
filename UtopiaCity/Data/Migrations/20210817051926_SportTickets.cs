...
{
    public partial class SportTickets : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidentAccountId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportTickets", x => x.TicketId);
                    table.ForeignKey(
                        name: "FK_SportTickets_RersidentAccount_ResidentAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SportTickets_ResidentAccountId",
                table: "SportTickets",
