...
namespace UtopiaCity.Data.Migrations
{
    ...
    [Migration("20211010144605_Soft delete has been removed")]
    partial class Softdeletehasbeenremoved
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UtopiaCity.Models.Media.Advertisment", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UtopiaCity.Models.Media.DataCapture", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");

                    b.Property<bool?>("ApproversApprove")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("DataCaptures");
                });

            modelBuilder.Entity("UtopiaCity.Models.Media.Employee", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("Employees_");
                });

            modelBuilder.Entity("UtopiaCity.Models.Media.Role", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UtopiaCity.Models.Media.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("UtopiaCity.Models.Media.Advertisment", b =>
                {
                    b.HasOne("UtopiaCity.Models.Media.Employee", "Employee")
                        .WithMany("Advertisments")
                        .HasForeignKey("EmployeeId");

                    b.HasOne("UtopiaCity.Models.Media.User", "User")
                        .WithMany("Advertisments")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("UtopiaCity.Models.Media.Employee", b =>
                {
                    b.HasOne("UtopiaCity.Models.Media.Role", "Role")
                        .WithMany("Employees")
                        .HasForeignKey("RoleId");
                });
