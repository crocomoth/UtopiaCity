...
namespace UtopiaCityTest.Controllers.Sport
{
    public class SportEventControllerTests
    {
        ...
        {
            //arrange
            _sportEventServiceMock.Setup(x => x.GetAllSportEvents()).ReturnsAsync(new List<SportEvent>());
            var controller = new SportEventController(_sportEventServiceMock.Object, _sportComplexServiceMock.Object, _mapper);
        ...
        {
            //arrange
            _sportEventServiceMock.Setup(x => x.GetSportEventById("1")).ReturnsAsync(_sportEventForTests);
            _sportComplexServiceMock.Setup(x => x.GetAllSportComplexesTitles()).ReturnsAsync(new List<string>());
            var controller = new SportEventController(_sportEventServiceMock.Object, _sportComplexServiceMock.Object, _mapper);
        ...
        public void Create_MethodPost_RedirectsToAllSportEvents()
        {
            ...
            _sportEventServiceMock.Setup(x => x.AddSportEventToDb(_sportEventForTests));
            var controller = new SportEventController(_sportEventServiceMock.Object, _sportComplexServiceMock.Object, _mapper);
        ...
        public void Delete_MethodPost_RedirectsToAllSportEvents()
        {
            //arrange
            _sportEventServiceMock.Setup(x => x.GetSportEventById("1")).ReturnsAsync(_sportEventForTests);
            _sportEventServiceMock.Setup(x => x.RemoveSportEventFromDb(_sportEventForTests));
            var controller = new SportEventController(_sportEventServiceMock.Object, _sportComplexServiceMock.Object, _mapper);
        ...
        public void Edit_MethodPost_RedirectsToAllSportEvents()
        {
            //arrange
            _sportComplexServiceMock.Setup(x => x.GetSportComplexIdByTitle("title_1")).ReturnsAsync("1");
            _sportEventServiceMock.Setup(x => x.UpdateSportEventInDb(_sportEventForTests));
            var controller = new SportEventController(_sportEventServiceMock.Object, _sportComplexServiceMock.Object, _mapper);
        ...
        {
            //arrange
            _sportEventServiceMock.Setup(x => x.GetSportEventById("1")).ReturnsAsync(default(SportEvent));
            var controller = new SportEventController(_sportEventServiceMock.Object, _sportComplexServiceMock.Object, _mapper);
